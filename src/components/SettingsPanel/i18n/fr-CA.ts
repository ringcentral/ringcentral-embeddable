export default {
  ...
  textDescription: 'Choisissez le numéro de téléphone par défaut pour envoyer des textos.',
  ...
  hudDescription: 'Surveillez les contacts, vérifiez leur présence et appelez ou envoyez un texto depuis le HUD.',
  autoLogCallsDescription: 'Journalisez automatiquement un appel lorsqu’il se termine dans cette application.',
  autoLogSMSDescription: 'Journalisez automatiquement les textos lorsque des messages sont envoyés ou reçus dans cette application.',
  callLogging: 'Journalisation des appels',
  smsLogging: 'Journalisation des textos',
  callAndSmsLogging: 'Journalisation des appels et des textos',
  open: 'Ouvrir',
