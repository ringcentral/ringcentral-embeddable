...
![HUD](../assets/hud-call-queues.png){style="max-width: 400px"}
...
!!! tip "Enable SMS shared inbox"
    Follow the article [here](https://support.ringcentral.com/article-v2/managing-a-shared-sms-inbox.html?brand=RingCentral&product=RingEX&language=en_US) to enable SMS shared inbox.

![SMS shared inbox](../assets/shared-sms.png){style="max-width: 400px"}
