...
exports.default = DurationWidget;
...
function DurationWidget(props) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        (0, utils_1.labelValue)(react_1.default.createElement(spring_ui_1.FormLabel, { htmlFor: `${id}__hours`, label: label || undefined }), hideLabel),
        react_1.default.createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 12 } },
            react_1.default.createElement("span", { style: { flex: '1 1 140px', minWidth: 0 } },
                react_1.default.createElement(spring_ui_1.TextField, { id: `${id}__hours`, type: "number", size: "large", value: hours, placeholder: "0", fullWidth: true, disabled: isDisabled, required: required, error: rawErrors.length > 0, onChange: ({ target: { value: nextHours } }) => emitChange(nextHours, minutes), onBlur: ({ target: { value: nextHours } }) => emitBlur(nextHours, minutes), onFocus: ({ target: { value: nextHours } }) => emitFocus(nextHours, minutes), inputProps: { min: 0, step: 1, 'aria-label': hoursLabel }, endAdornment: react_1.default.createElement(spring_ui_1.Text, { className: "typography-descriptor" }, hoursUnitLabel), "aria-describedby": describedBy, clearBtn: false })),
            react_1.default.createElement("span", { style: { flex: '1 1 140px', minWidth: 0 } },
                react_1.default.createElement(spring_ui_1.TextField, { id: `${id}__minutes`, type: "number", size: "large", value: minutes, placeholder: "0", fullWidth: true, disabled: isDisabled, required: required, clearBtn: false, error: rawErrors.length > 0, onChange: ({ target: { value: nextMinutes } }) => emitChange(hours, nextMinutes), onBlur: ({ target: { value: nextMinutes } }) => emitBlur(hours, nextMinutes), onFocus: ({ target: { value: nextMinutes } }) => emitFocus(hours, nextMinutes), inputProps: { min: 0, step: minuteStep, 'aria-label': minutesLabel }, endAdornment: react_1.default.createElement(spring_ui_1.Text, { className: "typography-descriptor" }, minutesUnitLabel), "aria-describedby": describedBy })))));
}
