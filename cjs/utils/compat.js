...
exports.getLinkVariant = getLinkVariant;
exports.getTypographyClassName = getTypographyClassName;
exports.getTypographyComponent = getTypographyComponent;
exports.getTextColor = getTextColor;
exports.getDescriptionColor = getDescriptionColor;
const colorMap = {
    primary: 'primary',
    secondary: 'secondary',
    success: 'success',
...
function getButtonColor(color, fallback = 'primary') {
    var _a;
    if (!color) {
        return fallback;
    }
...
function getButtonVariant(variant, fallback = 'contained') {
    var _a;
    if (!variant) {
        return fallback;
    }
...
function getIconButtonColor(color, fallback = 'neutral') {
    var _a;
    if (!color) {
        return fallback;
    }
...
function getLinkVariant(variant, color) {
    if (variant === 'inverted') {
        return 'inverted';
    }
...
function getTypographyClassName(variant) {
    var _a;
    if (!variant) {
...
function getTypographyComponent(variant, isBulletedList) {
    var _a;
    if (isBulletedList) {
        return 'li';
    }
...
function getDescriptionColor(color) {
