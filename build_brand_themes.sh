...
echo "No need this now, we use css variables to change theme"
...
# BRAND=att DISABLE_MINIMIZE=1 npm run build
# cp release/att/app.css release/app.att.css
# rm -rf release/att

# BRAND=bt DISABLE_MINIMIZE=1 npm run build
# cp release/bt/app.css release/app.bt.css
# rm -rf release/bt

# BRAND=telus DISABLE_MINIMIZE=1 npm run build
